...
@Composable
fun CardListItem(card: CardListing) {
...
fun PreviewCardListItem(){
    YGOCollectionTheme {
        CardListItem(card = CardListing("Contrast HERO Chaos", "FusionMonster", "https://ygoprodeck.com/pics/23204029.jpg", 3000, 3000, 8, linkval = null, scale = null))
    }
}